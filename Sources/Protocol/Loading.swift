...
//    }
//    
//    func show(duration: TimeInterval = 30) {
...
//        }
//        return LoadingManager.add(listener: listener, key: key)
        return Disposables.create() //temp - an
    }
