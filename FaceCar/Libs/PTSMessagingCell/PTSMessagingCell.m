...
- (void)layoutSubviews {
    ...
    if (self.sent == YES) {
        ...
        timeLabelFrame = CGRectMake(40.0f + textMarginHorizontal, 0.0f, dateSize.width, dateSize.height);
        
        ballonViewFrame = CGRectMake(40.0f, timeLabelFrame.size.height, textSize.width + 2*textMarginHorizontal, textSize.height + 2*textMarginVertical);
        
        avatarImageFrame =  CGRectMake(5.0f, self.contentView.frame.size.height - 2*30.0f, 30.0f, 30.0f);
        
        messageLabelFrame = CGRectMake(textMarginHorizontal + ballonViewFrame.origin.x, ballonViewFrame.origin.y + textMarginVertical, textSize.width, textSize.height);
    }
